...
export const SERVICE_REGISTRY: ServiceCapability[] = [
  ...
  },
  {
    ...
    description:
      'International hotel booking via Redaug: search by location, real-time room/rate availability, two-step create-then-pay flow supporting monthly settlement and Active Payment (EVO), cancel and partial check-out.',
    category: 'hotel',
    version: 'v1',
    provider: 'redaug',
    ...
    verb_descriptions: {
      ...
      'pay-order': 'Settle a created order (monthly_settlement, or Active_Payment via --merchant-trans-id).',
    ...
    workflow: [
      ...
      'pay-order (settles: monthly_settlement or Active_Payment)',
